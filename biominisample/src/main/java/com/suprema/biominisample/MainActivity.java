...
import static android.serialport.DeviceControlSpd.PowerType.MAIN_AND_EXPAND;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Open fingerprinter USB
        findViewById(R.id.buttonOpenDevice).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    deviceControlSpd = new DeviceControlSpd("NEW_MAIN", 22, 8);
                    deviceControlSpd.PowerOnDevice();
                    deviceControlSpd = new DeviceControlSpd("EXPAND", 10);
                    deviceControlSpd.PowerOnDevice();
                    ...
                    timer.schedule(task, 1000); //Analog switching, delay time is too small will fail
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
        ...
        findViewById(R.id.buttonToF2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this,OnKeyDownActivity.class);
    ...
    class PageAdaptor extends PagerAdapter {
        ...
        public PageAdaptor(LayoutInflater inf) {
            this.infalter = inf;
        }
        ...
        switch (keyCode) {
            ...
            case KeyEvent.ACTION_DOWN:
                if ((System.currentTimeMillis() - mkeyTime) > 2000) {
                    ...
                    try {
                        deviceControlSpd = new DeviceControlSpd(); //Exit the application and turn off the Fingerprinter USB,
                                                                    // otherwise the type-c will not be used.
                        deviceControlSpd.newSetGpioOff(22);
                        deviceControlSpd.newSetGpioOff(8);
                        finish();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
